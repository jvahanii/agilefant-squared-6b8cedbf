does this contain items with no backlog assignments?
...
export function generateMockData() {
  ...
  "wi-2f795e7a": {
    ...
    "title": "alemmista backlogeista eri näkyvien itemien pitäisi jotenkin visuaalisesti olla erinäköiseiä, esim. punainen lappu harmaana tms",
