...
export function generateMockData() {
  const data = {
    ...
    backlogTrees: {
      "227ff1d1-36df-4f46-b97e-483ada92ccfb::tree-87b6c6d1": {
        ...
        name: "TODO",
        rootBacklogIds: ["bl-0e0d83c7", "bl-98944c30"],
        rank: 2,
      },
  ...
  return {
    workItems: data.workItems as Record<string, WorkItem>,
    backlogs: data.backlogs as Record<string, Backlog>,
    backlogTrees: data.backlogTrees as Record<string, BacklogTree>,
  };
}
