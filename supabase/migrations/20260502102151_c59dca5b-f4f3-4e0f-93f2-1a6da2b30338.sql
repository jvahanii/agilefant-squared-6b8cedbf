-- Add respawn_minute column
ALTER TABLE public.work_items
  ADD COLUMN IF NOT EXISTS respawn_minute integer;

-- Update build_organization_snapshot: to_jsonb(w) automatically picks up the new column,
-- so no change needed there.

-- Update restore_organization_backup to read respawn_minute from snapshot
...
-- Update remove_tree_share_with_copy to copy respawn_minute as well
